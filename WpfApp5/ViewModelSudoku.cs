    ...
    public class ViewModelSudoku
    {
     ...
     NbRows_Per_Block = 2 ________________|                |-------|-------|-------| |-------|-------|-------|            |
                                          ...
                                          |__              |_______|_______|_______| |_______|_______|_______|            |       
                                                           ...
                                                           |       |       |       | |       |       |       |            |
                                                           |   0   |   1   |   2   | |   0   |   1   |   4   |            |
                                                           |-------|-------|-------| |-------|-------|-------|            |_________________ NbBlocks_Col 
                                                           |   7   |   3   |   0   | |   0   |   0   |   5   |            |                  = NbRows_Per_Block
                                                           |_______|_______|_______| |_______|_______|_______|            |                  = 3
                                                            _______________________   _______________________             |
                                                           |       |       |       | |       |       |       |            |                  =>  nbCellsRows_In_Sudoku  
                                                           |   6   |   0   |   1   | |   0   |   4   |   0   | `          |                      = NbRows_Per_Block * nbBlocksRow
                                                           |-------|-------|-------| |-------|-------|-------|            |                      = 2 * 3
                                                           |   2   |   0   |   0   | |   0   |   0   |   0   |            |                      = 6
                                                           |_______|_______|_______| |_______|_______|_______|          __|  
                                                 
                                
                                                        |______________________________________________________|                               nbCellsCols_In_Sudoku = nbCellsRows_In_Sudoku
                                                                                    |
                                                                                    |
                                                                                    |
                                                                                    |
        ...
        */
        ...
        public ViewModelSudoku( int nbRows_per_block, int nbCols_per_block)
        {
